    ...
    <div class="auth-container">
        ...
        <div class="left-side">
            <div class="left-content">
                ...
                <h1>A.K.S.Y.O.N</h1>
                <p>Admin Dashboard - Manage your community reporting system with powerful tools and insights.</p>
        ...
        <div class="right-side">
            <div class="right-content">
                ...
                <div style="text-align: center; margin-top: 30px;">
                    <a href="{{ route('user.login') }}" style="color: #64748b; text-decoration: none; font-size: 0.9rem;">
                        ← Back to User Login
                    </a>
                    <div style="margin-top: 15px;">
                        <span style="color: #64748b; font-size: 0.9rem;">Don't have an account? </span>
                        <a href="{{ route('admin.register') }}" style="color: #3b82f6; text-decoration: none; font-size: 0.9rem; font-weight: 600;">
                            Register as Admin
                        </a>
                    </div>
                </div>
