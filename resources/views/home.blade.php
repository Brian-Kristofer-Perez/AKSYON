...
<body>
    ...
    <script>
        // User data - Replace with actual data from Laravel Auth
        const currentUser = {
            name: "Rebecca", // Change this to: {{ Auth::user()->name }} in Laravel
            firstName: "Rebecca", // {{ Auth::user()->first_name }}
            lastName: "Smith" // {{ Auth::user()->last_name }}
        };
        ...
        document.querySelector('.profile-circle').textContent = initials.toUpperCase();
